<%-- 
    Document   : Admin_removedoc
    Created on : Jul 18, 2021, 12:04:41 AM
    Author     : Jaiswalji
--%>
...
<div class="navbar">
  ...
  <a href="FetchPatient">View Patient</a> 
   <a href="Admin_removedoc.html">Remove Doctor</a>
<a href="OMP.html" >Logout</a>
 </div>
<h2><center><u>Delete Doctor</u></center></h2>
   <br>
<form action="RemoveDoctor" method="Post">  
     <center>
    <h2 for="doctor">Doctor Id:
</h2>
   </center>
    <%
...
"jdbc:mysql://localhost:3306/medical?useSSL=false","root","");  
 ...
 String sql="select doctor_id,doctor_name from doctor order by doctor_id ";
