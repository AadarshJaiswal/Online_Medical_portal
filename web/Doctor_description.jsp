<%-- 
    ...
    Created on : Jul 17, 2021, 5:22:42 PM
    Author     : Jaiswalji
--%>
...
System.out.print(e);
    ...
    <center><h2>Treatment :</h2> <input type="text" name="treatment" required=""/><br/> </center> 
     <center><h2>Note :</h2> <input type="text" name="note"/><br/> </center> 
